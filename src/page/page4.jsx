...
import Textbox_close2 from '../component/textbox_close1';
    ...
    return(
        <div className='section'>
            <div className='container'>
                ...
                {clickstate==true?<Textbox2 clickstate={clickstate} changeClick={changeClick}/>:<Textbox_close2 clickstate={clickstate} changeClick={changeClick}/>}
