...
import Textbox_close1 from '../component/textbox_close1';
    ...
    return(
        <div className='section'>
            <div className='container'>
                ...
                {clickstate==true?<Textbox1 clickstate={clickstate} changeClick={changeClick}/>:<Textbox_close1 clickstate={clickstate} changeClick={changeClick}/>}
